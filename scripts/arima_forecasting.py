...
# load historical iepfa time series data
...
# forecast future steps and confidence intervals
...
# plot individual time series forecast with confidence band
...
# plot combined 3-panel forecast chart
...
# run arima forecasting pipeline and save outputs
def run_arima_pipeline():
    print("=================================================================")
    print("      IEPFA TIME SERIES MODELING & ARIMA FORECASTING (2026-2030)  ")
    print("=================================================================\n")
    
    df_claims, df_approvals, df_div, df_shares = load_historical_series()
    
    print(">> [1/3] Modeling Form IEPF-5 Claim Filings...")
    ...
    print(f"   Optimal Order: ARIMA{order_claims} | AIC: {aic_claims:.2f}")
    
    print(">> [2/3] Modeling Claims Approved for Refund...")
    ...
    print(f"   Optimal Order: ARIMA{order_app} | AIC: {aic_app:.2f}")

    print(">> [3/3] Modeling Dividend Restitution Amounts (INR Cr)...")
    ...
    print(f"   Optimal Order: ARIMA{order_div} | AIC: {aic_div:.2f}\n")
    ...
    with open(summary_path, "w", encoding="utf-8") as f:
        f.write("=================================================================\n")
        f.write("   IEPFA ARIMA TIME SERIES FORECASTING AND CAPACITY PROJECTIONS  \n")
        f.write("=================================================================\n\n")
    ...
    print(f">> Forecast summary exported to: {summary_path}")
    print("\nARIMA pipeline completed successfully.")
