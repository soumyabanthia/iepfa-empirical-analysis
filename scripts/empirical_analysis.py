...
from welfare_mpc_analysis import run_welfare_pipeline
...
def load_and_clean_data(filepath):
    try:
        ...
        print(f"Warning: Could not load {filepath} ({e}), falling back to sample panel data.")
...
if __name__ == "__main__":
    ...
    print("\nRunning ARIMA forecasting pipeline...")
    run_arima_pipeline()

    print("\nRunning welfare and MPC analysis...")
    run_welfare_pipeline()

    print(f"\nDone. Outputs saved to '{PLOTS_DIR}'.")
